  ...
  return (
    <section className="h-screen w-full flex flex-col justify-center items-center bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white">
      <div className="text-center animate-fadeIn">
        ...
        <button
          onClick={() => navigate("/")}
          className="mt-6 bg-white text-blue-600 font-semibold mr-5 px-8 py-3 rounded-full shadow-lg hover:bg-gray-100 hover:scale-105 transition-all duration-300 ease-in-out transform animate-pulse"
        >
          Go Back to Home
        </button>
        <button
